...
jQuery(document).ready(function() {
	...
	jQuery('.carousel-4columns').jcarousel({
        buttonNextHTML: '<div class="effect-loaded"><i class="fa fa-angle-right"></i></div>',
		buttonPrevHTML: '<div class="effect-loaded"><i class="fa fa-angle-left"></i></div>'
    });
	...
	jQuery('#in-tabs-slider').jcarousel({
		scroll:1,
        buttonNextHTML: '<div><i class="fa-angle-right"></i></div>',
		buttonPrevHTML: '<div><i class="fa-angle-left"></i></div>'
    });
