...
(function ($) {
  jQuery.fn.nanoGallery = function (options) {
    var settings = $.extend(true, {
      ...
      slideshowDelay:3000,
      i18n:{
        'paginationPrevious':'Anterior','paginationPrevious_FR':'Précédent','paginationPrevious_DE':'Zurück',
        'paginationNext':'Siguiente','paginationNext_FR':'Suivant','paginationNext_DE':'Weiter'
        }
    }, options );
...
function nanoGALLERY() {
   var g_options=null,
    ...
    g_i18nLang='';
    var g_i18nTranslations={'paginationPrevious':'Anterior','paginationNext':'Siguiente','breadcrumbHome':'Lista de Categorias'};
